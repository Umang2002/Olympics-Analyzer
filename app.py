...
if user_menu=="Country-wise Analysis" :
    ...
    st.title(selected_country + " Medals tally over the year")
    st.plotly_chart(fig)

    st.title(selected_country + " medals in each sports")
    ...
    x = helper.mostsuccessful_by_country(df,selected_country);
    st.table(x)
